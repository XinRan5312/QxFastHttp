package com.xinran.fasthttp.services;
...
/**
 * 监测网速的Service
 * 来自：http://www.jianshu.com/p/5678264e82d5
 * Created by qixinh on 16/6/13.
 */
public class QxNetWorkService extends Service{
    ...
    public final static String IS_NET_SPEED_SLOW = "is_slow_net_speed";
    @Override
            ...
            if (isNetBad) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        sendBroadcast(receiverIntent);//然后就可以取消请求，提示用户网速很差重试或者是直接提示处于离线状态
                    }
                });
            }
        }
